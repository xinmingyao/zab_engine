...
%   {ok,"v3"}=rpc:call('n1@localhost',zabe_learn_leveldb,get,["k3"]),
    ...
    {error,not_ready}=rpc:call('n3@localhost',zabe_learn_leveldb,put,[Key,Value]),
    slave:start(?HOST,n2,Arg),  
    rpc:call('n2@localhost',zabe_learn_leveldb_SUITE,setup,["/tmp/p2.db"]),
    ct:sleep(1000),
    rpc:call('n2@localhost',zabe_learn_leveldb,start_link,[Nodes,Op2,D2]),
    ct:sleep(1000),
    ok=rpc:call('n3@localhost',zabe_learn_leveldb,put,[Key,Value]),
    ok
    .
